...
import 'package:formus/features/details/components/text_item.dart';
import 'package:formus/features/details/components/vote_widget.dart';
import 'package:formus/features/details/components/youtube_view.dart';
...
class DetailsView extends StatelessWidget {
          ...
          return SingleChildScrollView(
            child: Column(
              children: [
                ...
                YoutubeView(videoKey: viewModel.key ?? ''),
  ...
  Color get colorFavoriteIcon {
    if (viewModel.isFavorited) return Colors.red;
